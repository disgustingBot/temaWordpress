...
while($j<=2){ ?>
    ...
    <?php if ($j==0) {
      ...
      <section id="sec1" class="categorySection">
    ...
    <?php if ($j==1) {
      ...
      $blogPosts=new WP_Query($args); ?>
      <section id="sec2" class="categorySection">
        <div class="sectionMarker">
    ...
    while($blogPosts->have_posts()) {
      ...
      <figure class="post mainPost mainPost1">
        <figcaption class="postFigCaptioncito mainFigcaption mainFigcaption1">
          <a class="mainTxt" href="<?php the_permalink(); ?>"><h6 class="mainTxt"><?php the_title(); ?></h6></a>
          <?php if($i==0){ ?><a class="mainPostDescription" href="<?php the_permalink(); ?>"><?php the_excerpt(); ?></a><?php } ?>
          <?php if(function_exists('the_views')){ ?><p class="vistoNVeces ">👁 <?php the_views(); ?></p><?php } ?>
          <p class="postAuthor "><strong class="authorColor">Por <?php the_author(); ?></strong> - <?php the_time('F j, Y'); ?></p>
        </figcaption>
    ...
    while($blogPosts->have_posts()){$blogPosts->the_post(); ?>
      ...
      <figure class="post<?php
        ...
        <img class="postImg <?php
          if($i>0 && $i<=4) {if($i % 2) {echo ' scndCorridorImgSmall';} else {echo ' scndCorridorImgBig';}}if($i>4){echo ' bottomPostsImg';}
          ?>" src="<?php echo get_the_post_thumbnail_url(get_the_ID()); ?>" alt="">
        <figcaption class="postFigCaptioncito">
          <a class="postTxt1 " href="<?php the_permalink(); ?>"><p><?php the_title(); ?></p></a>
          <p class="postAuthor "><strong class="authorColor">Por <?php the_author(); ?></strong> - <?php the_time('F j, Y'); ?></p>
          <?php if(function_exists('the_views')){ ?><p class="vistoNVeces ">👁 <?php the_views(); ?></p><?php } ?>
        </figcaption>
      </figure>
