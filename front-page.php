    ...
    <?php if ($j==1) {
      ...
      <section id="sec2" class="section">
        <div class="sectionMarker">
          ...
          <h3><?php echo get_category_by_slug($categoryName)->name; ?></h3>
          <svg class="markerLetter markerSecondLetter"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 19.92 25.92" enable-background="new 0 0 19.92 25.92"><path d="M7.92,0.48l0.432,3.504C10.72,1.328,13.136,0,15.601,0c1.312,0,2.576,0.192,3.791,0.576L19.92,0.72l-0.239,6.96H16.56l-0.72-3.6c-2.752,0-5.071,1.248-6.96,3.744V22.08l4.801,1.2v2.64H0v-2.64l4.08-1.2V4.32L0,3.36V0.72L7.92,0.48z"/></svg>
        </div>
