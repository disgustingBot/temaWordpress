      ...
      <div id="footerSocialContainer">
        ...
        <div id="footerSvgSocialContainer">
          ...
          <a href="https://www.instagram.com/gaeapeople/" target="_blank">
            <svg class="footerSocialSvg"  id="footerInstagram" fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
          ...
          <a href="https://www.youtube.com/user/omnigaea" target="_blank">
            <svg class="footerSocialSvg" id="footerYouTube" fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
