...
<?php
 ...
 ?>
    ...
    <ul id="postSocialMenu">
      <h4>Compartir</h4>
      <li>
        <a href="<?php echo $twitterURL; ?>" target="blank" rel="noopener noreferrer" id="shareTwitter">
      ...
      <li>
        <a href="<?php echo $facebookURL; ?>" target="blank" rel="noopener noreferrer" id="shareFacebook">
      ...
      <li>
        <a href="<?php echo $linkedInURL; ?>" target="blank" rel="noopener noreferrer" id="shareLinkedIn">
