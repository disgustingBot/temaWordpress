...
<?php echo get_sidebar('sidebar1')?>
    ...
    <ul id="postSocialMenu">
      <h4>Compartir</h4>
      <li>
        <a href="https://twitter.com/intent/tweet?url=http%3A%2F%2Flocalhost%2FGaea%2FCATEGORY%2FSLUG%2F&amp;text=TITLE%3A%20DESCRIPTION" target="blank" rel="noopener noreferrer" id="shareTwitter">
      ...
      <li>
        <a href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Flocalhost%2FGaea%2FCATEGORY%2FSLUG%2F" target="blank" rel="noopener noreferrer" id="shareFacebook">
      ...
      <li>
        <a href="https://www.https://www.instagram.com/gaeapeople/" target="blank" id="shareInstagram">
      ...
      <li>
        <a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=http%3A%2F%2Flocalhost%2FGaea%2FCATEGORY%2FSLUG%2F&amp;title=TITLE&amp;summary=DESCRIPTION&amp;source=" target="blank" rel="noopener noreferrer" id="shareLinkedIn">
      ...
      <li>
        <a href="https://www.youtube.com/user/omnigaea" target="blank" id="shareYoutube">
    ...
    <div class="relatedSection">
      ...
      if ( $related->have_posts() ): ?>
        ...
        <?php while($related->have_posts()): $related->the_post(); ?>
          <?php if ($i % 2 == 0) { ?><flex class="relatedFlex"><?php } ?>
            <figure class="relatedPost">
              <a href="<?php the_permalink(); ?>">
                <img class="relatedPostImg" src="<?php echo get_the_post_thumbnail_url(get_the_ID()); ?>" alt="">
              </a>
              <figcaption>
                <a href="<?php the_permalink(); ?>">
                  <h6><?php the_title(); echo $featuredID; ?></h6>
                </a>
                <p class="sec1MainAuthor">Por <?php the_author(); ?> <span>- <?php the_time('M j, Y'); ?></span></p>
                <!-- <p><?php echo get_the_category_list(', '); ?></p> -->
              </figcaption>
            </figure>
          <?php if ($i % 2 == 1) { ?></flex><?php } ?>
        <?php $i++; endwhile; ?>
